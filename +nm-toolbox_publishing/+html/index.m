...
nm-toolbox_publishing.html.exo1;
...
n = 1024;
Jmin = 4;
y = nm-toolbox_signal.perform_wavelet_transf(zeros(n,1), Jmin, +1, options);
nJ = 3;
nT = 3;
...
for j=1:nJ
    ...
    for i=1:nT
        y = y*0;
        y(sel(i),:,j+1) = 1;
        x(:,i) = nm-toolbox_signal.perform_wavelet_transf(y, Jmin, -1, options);
    end
    hold on;
    h = plot(x); axis('tight');
    set(h, 'LineWidth', 2);
...
nm-toolbox_publishing.html.exo2;
