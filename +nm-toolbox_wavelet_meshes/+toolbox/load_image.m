function M = nm-toolbox_signal.load_image(type, n, options)
...
switch lower(type)
    ...
    case 'ellipse-thin'
        ...
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('ellipse', n, options);
    case 'ellipse-fat'
    ...
    case 'square-tube-1'
        ...
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('square-tube', n, options);
    case 'square-tube-2'
    ...
    case 'polygon-8'
        options.nb_points = 8;
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('polygon', n, options);
    case 'polygon-10'
        options.nb_points = 8;
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('polygon', n, options);
    case 'polygon-12'
    ...
    case 'pacman'
        ...
        options.radius = 0.45;
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('disk', n, options);        
        x = linspace(-1,1,n);
        [Y,X] = meshgrid(x,x);
        T =atan2(Y,X);
        M = M .* (1-(abs(T)<theta/2));
    case 'square-hole'
        ...
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('disk', n, options); 
        options.scaling = 0.5;
        M = M - nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('polygon-10', n, options); 
    ...
    case 'squareregular'
        M = nm-toolbox_general.rescale(nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('square',n,options));
        if not(isfield(options, 'alpha'))
            options.alpha = 3;
        end
        S = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('fnoise',n,options);
        M = M + nm-toolbox_general.rescale(S,-0.3,0.3); 
        
    case 'regular1'
        options.alpha = 1;
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('fnoise',n,options);
    case 'regular2'
        options.alpha = 2;
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('fnoise',n,options);
    case 'regular3'
    ...
    case 'square_texture'
        M = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('square',n);
        M = nm-toolbox_general.rescale(M);
    ...
    case 'diskregular'
        M = nm-toolbox_general.rescale(nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('disk',n,options));
        if not(isfield(options, 'alpha'))
            options.alpha = 3;
        end
        S = nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.load_image('fnoise',n,options);
...
if sigma>0
    h = nm-toolbox_signal.compute_gaussian_filter( [9 9], sigma/(2*n), [n n]);
    M = nm-toolbox_signal.perform_convolution(M,h);
end

M = nm-toolbox_general.rescale(M) * 256;
