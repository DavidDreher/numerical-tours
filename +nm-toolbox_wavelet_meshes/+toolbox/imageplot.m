function nm-toolbox_signal.imageplot(M,str, a,b,c)
...
if iscell(M)
    ...
    for i=1:q
        ...
        nm-toolbox_wavelet_meshes.toolbox.nm-toolbox_signal.imageplot(M{i},str1, a,b,c-1+i);
    end
    global axlist;
...
if nbdims==1
    ...
    imagesc(nm-toolbox_general.rescale(M)); axis image; axis off;
end
if not(isempty(str))
    title(str);
end
