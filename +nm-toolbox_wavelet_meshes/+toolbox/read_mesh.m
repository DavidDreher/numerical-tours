...
switch file
    case {'triangle' 'square' 'square1' 'L' 'L1' 'tetra' 'oct' 'ico' 'rand'}
        [vertex,face] = nm-toolbox_wavelet_meshes.compute_base_mesh(file);
...
switch lower(ext)
    case 'off'
        [vertex,face] = nm-toolbox_graph.read_off(file);
    case 'ply'
    ...
    case 'tet'
        [vertex,face] = nm-toolbox_graph.read_tet(file);
    case 'm'
    ...
    case 'gim'
        sub_sample = 1;
        [M,Normal] = nm-toolbox_graph.load_gim(name, options);
