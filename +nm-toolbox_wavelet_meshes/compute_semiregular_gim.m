...
vertex0 = {}; face = {};
[vertex0{1}, face{1}] = nm-toolbox_wavelet_meshes.compute_base_mesh('oct');
options.base_mesh = 'oct';
for j=2:J
    [vertex0{j},face{j}] = nm-toolbox_wavelet_meshes.perform_mesh_subdivision(vertex0{j-1},face{j-1},1);
end
