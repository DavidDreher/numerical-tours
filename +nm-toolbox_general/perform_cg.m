...
options.null = 0;
niter = nm-toolbox_general.getoptions(options, 'niter_max', 100);
epsilon = nm-toolbox_general.getoptions(options, 'epsilon', 1e-5);
is_sdp = nm-toolbox_general.getoptions(options, 'is_sdp', 1);
use_cgs = nm-toolbox_general.getoptions(options, 'use_cgs', 1);
x = nm-toolbox_general.getoptions(options, 'x', []);

epsilon = nm-toolbox_general.getoptions(options, 'tol', epsilon);
niter = nm-toolbox_general.getoptions(options, 'maxit', niter);
