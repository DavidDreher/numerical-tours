...
% helpers
ms = nm-toolbox_general.getoptions(options, 'ms', 8);
fs = nm-toolbox_general.getoptions(options, 'fs', 20);
disp_legend = nm-toolbox_general.getoptions(options, 'disp_legend', 1);
disp_dim = nm-toolbox_general.getoptions(options, 'disp_dim', 2);
edge_factor = nm-toolbox_general.getoptions(options, 'edge_factor', .25);
