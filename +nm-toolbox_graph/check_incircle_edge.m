...
ic1 = nm-toolbox_graph.check_incircle(vertex, f1, points1 );

points2 = find_other(f1, edge(1,:), edge(2,:));
ic2 = nm-toolbox_graph.check_incircle(vertex, f2, points2 );
...
isconvex(I) = ( nm-toolbox_general.det3(A) .* nm-toolbox_general.det3(B) ) < 0;
