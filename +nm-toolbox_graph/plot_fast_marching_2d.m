...
path_width = nm-toolbox_general.getoptions(options, 'path_width', 3);
point_size = nm-toolbox_general.getoptions(options, 'point_size', 12);
...
% Z(open_list) = 0;
Z(close_list) = 0;
imagesc( nm-toolbox_general.rescale(Z) );
axis image;
axis off;
