...
W       = nm-toolbox_general.getoptions(options, 'W', ones(nverts,1) );
...
dmax    = nm-toolbox_general.getoptions(options, 'dmax', 1e9);
...
if exist('nm-toolbox_graph.perform_front_propagation_mesh')~=0
    [D,S,Q] = nm-toolbox_graph.perform_front_propagation_mesh(vertex, faces-1, W,start_points-1,end_points-1, nb_iter_max, H, L, values, dmax);
    Q = Q+1;
else
