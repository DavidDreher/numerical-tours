...
method = nm-toolbox_general.getoptions(options, 'method', 'fm');
svg_rate = nm-toolbox_general.getoptions(options, 'svg_rate', 10);
niter = nm-toolbox_general.getoptions(options, 'niter', Inf);
bound = nm-toolbox_general.getoptions(options, 'bound', 'sym');
