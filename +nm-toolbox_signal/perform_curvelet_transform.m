...
options.null = 0;
finest = nm-toolbox_general.getoptions(options, 'finest',1)  ; % =1(curv)  =2(wav)
nbscales = nm-toolbox_general.getoptions(options, 'nbscales', 5); % log2(size(M,1))-2;
nbangles_coarse = nm-toolbox_general.getoptions(options, 'nbangles_coarse', 16);
is_real = nm-toolbox_general.getoptions(options, 'is_real', 0);
