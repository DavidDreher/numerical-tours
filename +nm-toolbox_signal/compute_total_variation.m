...
weight_tv = nm-toolbox_general.getoptions(options, 'weight_tv', ones(size(y)) );
tv_norm = nm-toolbox_general.getoptions(options,'tv_norm', 'l2');

% options.bound = 'per';
g = nm-toolbox_signal.grad(y, options);
